...
# at the start of the game both user and computer have 0 points



#play multiple rounds until one of the winner can be found
comp_score = 0
user_score = 0
game_goal = 30
...
while comp_score < game_goal and user_score < game_goal:
    ...
    #start of round loop
    #for testing purposes, ask the user what the points for user
    #main starts here
    ...
    #show the score after the round
    print("*** game score ***")
    print(f"user score : {user_score} | computer score : {comp_score}")

# end of enter the game loop
print()
